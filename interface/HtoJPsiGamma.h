...
// found on file: root://cmsxrootd.fnal.gov//store/mc/RunIIFall17NanoAODv5/HtoJPsiGamma_TuneCP5_13TeV-pythia8/NANOAODSIM/PU2017_12Apr2018_Nano1June2019_102X_mc2017_realistic_v7-v1/250000/8EEB3BA0-9E04-AC44-AA78-ED82C143F4E3.root
//////////////////////////////////////////////////////////

#ifndef HtoJPsiGamma_h
#define HtoJPsiGamma_h
#include <iostream>
#include<iomanip>
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HtoJPsiGamma(TTree *tree = 0);
   virtual ~HtoJPsiGamma();
...
//	std::map<std::string, double>& lumiWtMap()  {return cutMap(hmap_, "lumiWtList");}
   ...
   //double intLumi = 27.070; // pb-1 (for D,E,F) for total : 41557
   double intLumi = 35.9;
   //double xsec;
   double xsec = 0.302; // fb (?, from xsdb) for z signal sample
   ...
   //TFile *outfile = new TFile("HtoJPsiGamma_hist_t3.root","RECREATE");
...
// used to generate this class and read the Tree.
    ...
    if (tree == 0) {
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/p/ppalit/public/hHtoJPsiGamma/CMSSW_9_4_8/src/offlineAnalysis_17/8EEB3BA0-9E04-AC44-AA78-ED82C143F4E3.root"); // Z signal before skimming     
      ...
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/p/ppalit/public/hHtoJPsiGamma/CMSSW_9_4_8/src/offlineAnalysis_17/A897EC1C-6A36-4149-BC29-6EE7BE5DC1E7.root");   // DY background   
    if (!f || !f->IsOpen()) {
      //f = new TFile("/afs/cern.ch/user/p/ppalit/public/hHtoJPsiGamma/CMSSW_9_4_8/src/offlineAnalysis_17/8EEB3BA0-9E04-AC44-AA78-ED82C143F4E3.root"); // Z signal before skimming
...
Long64_t HtoJPsiGamma::LoadTree(Long64_t entry)
{
...
void HtoJPsiGamma::Init(TTree *tree)
{
...
void HtoJPsiGamma::Show(Long64_t entry)
{
...
Int_t HtoJPsiGamma::Cut(Long64_t entry)
{
