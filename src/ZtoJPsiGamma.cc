...
void ZtoJPsiGamma::eventEfficiency(){
  ...
  TH1 *hcat1 = ZtoJPsiGamma::getHist1D("nPhoCatWt_triggP");
  if (hcat1 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_triggP",catlabels, "category of weighted events triggP", "Category");

  TH1 *hcat2 = ZtoJPsiGamma::getHist1D("nPhoCatWt_triggN");
  if (hcat2 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_triggN",catlabels, "category of weighted events triggN", "Category");

  TH1 *hcat3 = ZtoJPsiGamma::getHist1D("nPhoCatWt_muP");
  if (hcat3 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_muP",catlabels, "category of weighted events muP", "Category");

  TH1 *hcat4 = ZtoJPsiGamma::getHist1D("nPhoCatWt_muN");
  if (hcat4 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_muN",catlabels, "category of weighted events muN", "Category");



  TH1 *hcat5 = ZtoJPsiGamma::getHist1D("nPhoCatWt_phoP");
  if (hcat5 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_phoP",catlabels, "category of weighted events phoP", "Category");


  TH1 *hcat6 = ZtoJPsiGamma::getHist1D("nPhoCatWt_phoN");
  if (hcat6 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_phoN",catlabels, "category of weighted events phoN", "Category");

  TH1 *hcat7 = ZtoJPsiGamma::getHist1D("nPhoCatWt_PuUp");
  if (hcat7 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_PuUp",catlabels, "category of weighted events PuUp", "Category");

  TH1 *hcat8 = ZtoJPsiGamma::getHist1D("nPhoCatWt_PuDown");
  if (hcat8 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_PuDown",catlabels, "category of weighted events PuDown", "Category");


  TH1 *hcat9 = ZtoJPsiGamma::getHist1D("nPhoCatWt_eleVetoP");
  if (hcat9 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_eleVetoP",catlabels, "category of weighted events eleVetoP", "Category");


  TH1 *hcat10 = ZtoJPsiGamma::getHist1D("nPhoCatWt_eleVetoN");
  if (hcat10 != nullptr) {
  ...
  ZtoJPsiGamma::showEfficiency("nPhoCatWt_eleVetoN",catlabels, "category of weighted events eleVetoN", "Category");
  ...
  for (Long64_t jentry=0; jentry<nentries; jentry++) {
    ...
    outfile->cd("ZtoJPsiGamma");
     ...
     if(isMC()) {
       ...
       weight_scalefactor_mu1 *= ZtoJPsiGamma::SFCalc(mu_scale, vec_muTP4[0].Pt(), vec_muTP4[0].Eta(), 1);
       weight_scalefactor_mu2 *= ZtoJPsiGamma::SFCalc(mu_scale, vec_muTP4[1].Pt(), vec_muTP4[1].Eta(), 1);
	 ...
	 weight_scalefactor_SU_mu1 *= ZtoJPsiGamma::SFCalcSU(mu_scale, vec_muTP4[0].Pt(), vec_muTP4[0].Eta(), 1);
         weight_scalefactor_SU_mu2 *= ZtoJPsiGamma::SFCalcSU(mu_scale, vec_muTP4[1].Pt(), vec_muTP4[1].Eta(), 1);
       ...
       if(Photon_isScEtaEB[pho1id]) {
         weight_scalefactor_trigg *= ZtoJPsiGamma::triggSFCalc(trigg_scale_EB,vec_muTP4[0].Pt(),vec_phoP4[0].Pt());
         if(find_SU) {
           weight_scalefactor_SU_trigg *= ZtoJPsiGamma::triggSFCalcSU(trigg_scale_EB,vec_muTP4[0].Pt(),vec_phoP4[0].Pt());
         ...
         weight_scalefactor_trigg *= ZtoJPsiGamma::triggSFCalc(trigg_scale_EE,vec_muTP4[0].Pt(),vec_phoP4[0].Pt());
         if(find_SU) {
           weight_scalefactor_SU_trigg *= ZtoJPsiGamma::triggSFCalcSU(trigg_scale_EE,vec_muTP4[0].Pt(),vec_phoP4[0].Pt());
           weight_scalefactor_triggP =weight_scalefactor_trigg +weight_scalefactor_SU_trigg;
           weight_scalefactor_triggN =weight_scalefactor_trigg -weight_scalefactor_SU_trigg;
         }
       }
...
double ZtoJPsiGamma::SFCalc(TH2F* h, double pt, double eta, int id){
  double tmp_pt = pt;
  if(id == 1) {
    if (pt > 200)
...
double ZtoJPsiGamma::SFCalcSU(TH2F* h, double pt, double eta, int id){
  double tmp_pt = pt;
  if(id == 1) {
    if (pt > 200)
      tmp_pt = 199.; // Overflow Bin // Mu SF                                                                                                 
...
double ZtoJPsiGamma::triggSFCalc(TH2F* h, double pt_mu, double pt_pho) {
...
double ZtoJPsiGamma::triggSFCalcSU(TH2F* h, double pt_mu, double pt_pho) {
  double tmp_pt_mu = pt_mu;
  double tmp_pt_pho = pt_pho;
  if (pt_mu > 100) tmp_pt_mu = 99;
  if (pt_mu < 20) tmp_pt_mu = 21;
